...
# Create conversation with plugins - skills, MCP config, and hooks are merged automatically
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    skills = conversation.agent.agent_context.skills if conversation.agent.agent_context else []
