...
- [ ] `openhands-sdk/tests/sdk/context/test_agent_context_plugin.py`
...
- [ ] `openhands-sdk/tests/sdk/agent/test_agent_plugin_mcp.py`
...
- [ ] `openhands-agent-server/tests/agent_server/test_conversation_service_plugin.py`
...
- [ ] Update any tests that used the old plugin params pattern
...
- [ ] `openhands-sdk/examples/05_skills_and_plugins/03_plugin_via_agent_context/main.py`
  - Demonstrate loading plugin via AgentContext
  - Show MCP config merging
  - Show hook extraction and usage

- [ ] `openhands-sdk/examples/05_skills_and_plugins/03_plugin_via_agent_context/README.md`
  - Explain the pattern
  - Document when to use plugin_source vs load_public_skills

### 5.6 Cleanup and Final Testing (M6)

**Goal**: Remove obsolete code, ensure all tests pass.

#### 5.6.1 Remove Obsolete SDK Plugin Utilities

- [ ] Review `openhands-sdk/openhands/sdk/plugin/utils.py`
  - Determine if `merge_skills()`, `merge_mcp_configs()` are still needed
  - Remove or relocate as appropriate

- [ ] Review `openhands-sdk/openhands/sdk/plugin/plugin.py`
  - Determine if `Plugin.merge_into()` is still needed
  - Remove if superseded by AgentContext validator

#### 5.6.2 Integration Tests

- [ ] End-to-end test: SDK with plugin via AgentContext
- [ ] End-to-end test: Agent server with plugin via request
